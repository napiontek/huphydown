...
#' to specify using the Hu Physics LaTeX template and cls files.
#'
#' @export
#'
...
#'
#' @return A modified \code{pdf_document} based on the HU Physik LaTeX
#'   template
#' @examples
#' \dontrun{
#' output:huphydown::thesis_pdf
#' }
...
#' @examples
#' \dontrun{
#' output:huphydown::thesis_gitbook
#' }
...
#' a HU Physics Word template
#' @examples
#' \dontrun{
#' output:huphydown::thesis_word
#' }
